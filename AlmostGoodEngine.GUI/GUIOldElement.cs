...
namespace AlmostGoodEngine.GUI
{
 ...
 //       public GUIOldElement Parent { get; set; }
	//	public List<GUIOldElement> Children { get; set; } = [];
 ...
 //               if (Dock != GUIDock.None)
	...
	//	public T GetElement<T>() where T : GUIOldElement
	//	{
	...
	//	public List<T> GetElements<T>() where T : GUIOldElement
	//	{
	//		List<T> elements = [];
	...
	//	public GUIOldElement GetElementById(string id)
	//	{
	//		foreach (var child in Children)
	//		{
	//			if (child.Id == id)
	...
	//	public GUIOldElement GetElementByClass(string className)
	//	{
	//		foreach (var child in Children)
	//		{
	...
	//	public List<GUIOldElement> GetElementsByClass(string className)
	//	{
	//		List<GUIOldElement> elements = [];

...
namespace AlmostGoodEngine.GUI.Utils
{
	internal static class Draw2D
	{
		...
		private static void CreateThePixel()
		{
		...
		public static void FillRectangle(Rectangle rect, Color color, float depth)
		{
			if (pixel == null)
			{
				CreateThePixel();
			...
			SpriteBatch.Draw(pixel, rect, rect, color, 0f, Vector2.Zero, SpriteEffects.None, depth);
		}
		...
		public static void FillRectangle(Rectangle rect, Color color, float angle, float depth)
		{
			if (pixel == null)
			{
				CreateThePixel();
		...
		/// <param name="color">The color to draw the rectangle in</param>
		public static void FillRectangle(Vector2 location, Vector2 size, Color color)
		{
		...
		/// <param name="angle">The angle in radians to draw the rectangle at</param>
		/// <param name="color">The color to draw the rectangle in</param>
		public static void FillRectangle(Vector2 location, Vector2 size, Color color, float angle)
		{
			if (pixel == null)
			{
				CreateThePixel();
		...
		public static void FillRectangle(float x, float y, float w, float h, Color color, float angle)
		{
		...
		{
			DrawRectangle(rect, color, 1.0f, 0);
		}
		...
		{
			DrawRectangle(rect, color, 1.0f, depth);
		}
		...
		/// <param name="color">The color to draw the rectangle in</param>
		/// <param name="thickness">The thickness of the lines</param>
		public static void DrawRectangle(Rectangle rect, Color color, float thickness, float depth)
		{

			// TODO: Handle rotations
			// TODO: Figure out the pattern for the offsets required and then handle it in the line instead of here

			DrawLine(new Vector2(rect.X, rect.Y), new Vector2(rect.Right, rect.Y), color, thickness, depth); // top
			DrawLine(new Vector2(rect.X + 1f, rect.Y), new Vector2(rect.X + 1f, rect.Bottom + thickness), color, thickness, depth); // left
			DrawLine(new Vector2(rect.X, rect.Bottom), new Vector2(rect.Right, rect.Bottom), color, thickness, depth); // bottom
			DrawLine(new Vector2(rect.Right + 1f, rect.Y), new Vector2(rect.Right + 1f, rect.Bottom + thickness), color, thickness, depth); // right
		}
		...
		public static void DrawLine(Vector2 point1, Vector2 point2, Color color, float thickness, float depth)
		{
			// calculate the distance between the two vectors
			float distance = Vector2.Distance(point1, point2);
		...
		public static void DrawLine(Vector2 point, float length, float angle, Color color, float thickness, float depth)
		{
			if (pixel == null)
			{
				CreateThePixel();
		...
		public static void PutPixel(float x, float y, Color color)
		{
			PutPixel(new Vector2(x, y), color);
		}


		public static void PutPixel(Vector2 position, Color color)
		{
			if (pixel == null)
			{
				CreateThePixel();
		...
		public static void Draw(Texture2D texture, Vector2 position, Nullable<Rectangle> source, float rotation, Vector2 origin, float scale, Color color)
		{
			Draw2D.SpriteBatch.Draw(texture, position, source, color, rotation, origin, scale, SpriteEffects.None, 0f);
		}
	}
}
